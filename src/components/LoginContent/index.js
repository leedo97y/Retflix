...
const LoginContent = () => {
    ...
    const validateUser = formData => {
        ...
        const isFound = db.users.find(user => user.id === id && user.password === password);
        if (isFound) {
            ...
            <article className="LoginContent">
                <div className="LoginMainForm">
                    ...
                    <div className="LoginHelp">
                        ...
                        <a href="/LoginHelp" className="LoginHelpLink">
                            도움이 필요하신가요?
                        </a>
                    </div>
                </div>
                <div className="LoginSubText">
                    ...
                    <div className="RecaptchaMsg">
                        ...
                        {!visible && (
                            <div className="RecaptchaToU">
                                Google reCAPTCHA가 수집하는 정보에는 Google <br></br>{' '}
                                <a href="https://policies.google.com/privacy">개인정보처리방침</a>과{' '}
                                <a href="https://policies.google.com/terms">서비스 약관</a>이
                                적용되며, 해당 정보는 reCAPTCHA 서비스 제공, 관리 및 개선과 일반적인
                                보안 <br></br> 유지에 사용됩니다(Google의 개인 맞춤 광고에 사용 안
                                함).
                            </div>
                        )}
                    </div>
